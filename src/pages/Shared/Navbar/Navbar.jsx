...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className="navbar fixed z-10 bg-opacity-30 bg-black max-w-screen-xl text-white sticky top-0">
        <div className="navbar-start">
          ...
          <img className="w-40 h-20" src="https://i.ibb.co/wSrvKrF/Logo-copy.png" alt="" />
        </div>
      ...
      <div className="footer items-center p-4 bg-transparent bg-black max-w-screen-xl text-black ">
        <div className="items-center grid-flow-col">
          <div className="flex">
            <p className="flex me-5">
              <FaInbox className="me-2"></FaInbox> Info@printers.com
            </p>
            <p className="flex">
              <FaPhone className="me-2"></FaPhone> +91 0800 123 4567
            </p>
          </div>
        </div>
